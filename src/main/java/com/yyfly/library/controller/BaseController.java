package com.yyfly.library.controller;

import com.yyfly.library.util.OSUtils;
...
public class BaseController {
     ...
     * 缓存目录
     */
    @Value("${file.upload.location.windows}")
    private String windowsLocation;

    @Value("${file.upload.location.linux}")
